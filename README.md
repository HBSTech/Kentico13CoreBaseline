...
In your Kentico Admin instance, go to `Sites` - `Import Site or Object` and upload the [Baseline Site](Baseline_Generics.1.0.0.zip).  You can import these objects into an existing site or create the site from it.
