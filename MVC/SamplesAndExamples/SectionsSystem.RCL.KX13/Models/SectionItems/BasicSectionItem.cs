namespace SectionsSystem.Models.SectionItems
{
    ...
    public class BasicSectionItem
    {
        public BasicSectionItem()
        {
        }
        ...
        /// </summary>
        public Maybe<GeneralLink> GeneralLink
        {
            get
            {
                if (LinkItems
    ...
    public class BasicSectionItem<T> : BasicSectionItem
    {
        ...
        public BasicSectionItem(T itemModel)
        {
            ItemModel = itemModel;
        }
