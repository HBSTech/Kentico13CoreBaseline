...
[assembly: RegisterDocumentType(Search.CLASS_NAME, typeof(Search))]

namespace CMS.DocumentEngine.Types.Generic
{
	/// <summary>
	/// Represents a content item of type Search.
	/// </summary>
	public partial class Search : TreeNode
	{
		...
		/// </summary>
		public const string CLASS_NAME = "Generic.Search";


		/// <summary>
		/// The instance of the class that provides extended API for working with Search fields.
		/// </summary>
		private readonly SearchFields mFields;
		...
		public int SearchID
		{
			get
			{
				return ValidationHelper.GetInteger(GetValue("SearchID"), 0);
			}
			set
			{
				SetValue("SearchID", value);
			}
		}
		...
		/// <summary>
		/// Gets an object that provides extended API for working with Search fields.
		/// </summary>
		[RegisterProperty]
		...
		/// <summary>
		/// Provides extended API for working with Search fields.
		/// </summary>
		[RegisterAllProperties]
		public partial class SearchFields : AbstractHierarchicalObject<SearchFields>
		{
			/// <summary>
			/// The content item of type Search that is a target of the extended API.
			/// </summary>
			private readonly Search mInstance;


			/// <summary>
			/// Initializes a new instance of the <see cref="SearchFields" /> class with the specified content item of type Search.
			/// </summary>
			/// <param name="instance">The content item of type Search that is a target of the extended API.</param>
			public SearchFields(Search instance)
			{
				mInstance = instance;
			}
			...
			public int ID
			{
				get
				{
					return mInstance.SearchID;
				}
				set
				{
					mInstance.SearchID = value;
				}
			}
		...
		/// </summary>
		public Search() : base(CLASS_NAME)
		{
			mFields = new SearchFields(this);
		}
